...
public interface TaskGraphGenerator {
    ...
    public void setMinIncomingEdges(int minIncommingEdges) throws BoundaryConflictException,
            OutOfRangeException;

    public void setMaxIncomingEdges(int maxIncommingEdges) throws BoundaryConflictException,
            OutOfRangeException;
